...
\item 
  Function $s(k)$ has countably infinite set of zeros, and each of them has $\operatorname{Im} k = \atanh \frac{2 W}{W^2 + 1}$. For brevity, we define:
