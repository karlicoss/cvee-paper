...
spectrum and the system of its eigenstates is complete in
...
eigenstates converge to resonance states which are similar to eigenstates
...
graph, we are not aware of other works dealing with this problem.
...
\left\|v\right\|,
\]
or to be precise, its $\mathcal{L}^2[a, b]$ version:
\[
...
We are going to build a simple estimate for $s(k)$ over the upper complex
plane. This estimate will be independent of the complex part of
